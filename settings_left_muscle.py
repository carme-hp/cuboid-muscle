...
config = {
  ...
  "PreciceAdapter":{
    ...
    "preciceParticipantName":   "Left-Muscle", 
    "preciceSurfaceMeshes": [                                      # the precice meshes get created as the top or bottom surface of the main geometry mesh of the nested solver
      {
        "preciceMeshName":      "Left-Muscle-Mesh",         # precice name of the 2D coupling mesh
    ...
    "preciceSurfaceData": [
      {
        ...
        "preciceMeshName":      "Left-Muscle-Mesh",                 # name of the precice coupling surface mesh, as given in the precice xml settings file
      ...
      },
      {
        ...
        "preciceMeshName":      "Left-Muscle-Mesh",                 # name of the precice coupling surface mesh, as given in the precice xml settings 
