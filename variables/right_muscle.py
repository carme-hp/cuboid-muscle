...
dirichlet_bc = {} 
kd = nz-1 # set to 0 for left end and to nz-1 for right end
...
specific_states_call_enable_begin = 20.0                     # time of first fiber activation
specific_states_call_frequency = 0.02                       # frequency of fiber activation
